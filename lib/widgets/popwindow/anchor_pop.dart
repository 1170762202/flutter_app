...
class AnchorPop extends StatefulWidget {
  AnchorPop({
    Key? key,
    this.child,
    this.window,
...
class PopupWindowWidgetState<T> extends State<AnchorPop> {
  void mShowWindow() {
...
class _PopupWindowLayout extends SingleChildLayoutDelegate {
  ...
  Offset getPositionForChild(Size size, Size childSize) {
    ...
    if (isLocalToGlobal != null && isLocalToGlobal == true) {
      return globalOffset!;
    } else {
      return Offset(x, y);
    }
